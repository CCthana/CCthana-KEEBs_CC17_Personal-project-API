...
exports.registerSchema = Joi.object({ 
   ...
   password: Joi.string().required().pattern(/^[a-zA-Z0-9]{8,}$/).messages({'string.empty': 'password require', 'string.pattern.base' : 'password must be at least 8 character long'}),
